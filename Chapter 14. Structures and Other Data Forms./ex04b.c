...
struct info print_info(struct info person_info);
...
struct info print_info(struct info person_info)
{
    if (person_info.person_name.mname[0] == '\0')
    {
        printf("%s, %s -- %d\n", person_info.person_name.fname, 
        person_info.person_name.lname, person_info.soc_sec_num);
    }
    else 
    {
        printf("%s, %s %c. -- %d\n", 
        person_info.person_name.fname, person_info.person_name.lname, 
        person_info.person_name.mname[0], person_info.soc_sec_num);
    }
