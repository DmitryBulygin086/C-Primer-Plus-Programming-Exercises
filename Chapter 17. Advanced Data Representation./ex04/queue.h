...
/* precontition:     pq points to previously initialized queue  */
...
/* operation:   remove item from front of queuue */
/* precondition:   pq points to previously initialized queue  */
...
/*                operation emties the queue, the queue is  */
/*                reset to empty. If the queue is empty to  */
/*                begin with, queue is unchanged and the  */
/*            function returns False  */
bool DeQueue(Item * pitem, Queue * pq);

/* operation:      emty the Queue  */
/* precontiion:  pq points to previously initialized queue */
